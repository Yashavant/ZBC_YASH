class ZCL_ZSD_SALES_ORDER_MPC definition
  public
...
CLASS ZCL_ZSD_SALES_ORDER_MPC IMPLEMENTATION.
...
model->set_schema_namespace( 'ZSD_SALES_ORDER_SRV' ).
...
lo_nav_property = lo_entity_type->create_navigation_property( iv_property_name  = 'NAVHEADTOITEM' "#EC NOTEXT
                                                              iv_abap_fieldname = 'NAVHEADTOITEM' "#EC NOTEXT
                                                              iv_association_name = 'HEADTOITEM' ). "#EC NOTEXT
  endmethod.
...
lo_entity_type->bind_structure( iv_structure_name   = 'VBAP'
                                iv_bind_conversions = 'X' ). "#EC NOTEXT
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20200601041141'.                  "#EC NOTEXT
