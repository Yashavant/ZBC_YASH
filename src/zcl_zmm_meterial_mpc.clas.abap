class ZCL_ZMM_METERIAL_MPC definition
  public
...
CLASS ZCL_ZMM_METERIAL_MPC IMPLEMENTATION.
...
model->set_schema_namespace( 'ZMM_METERIAL_SRV' ).
...
***********************************************************************************************************************************
 ...
 lo_association = model->create_association(
                            iv_association_name = 'MatToPlant' "#EC NOTEXT
                            iv_left_type        = 'Material' "#EC NOTEXT
                            iv_right_type       = 'Plant' "#EC NOTEXT
                            iv_right_card       = 'M' "#EC NOTEXT
                            iv_left_card        = 'N'  "#EC NOTEXT
                            iv_def_assoc_set    = abap_false ). "#EC NOTEXT
* Referential constraint for association - MatToPlant
lo_ref_constraint = lo_association->create_ref_constraint( ).
lo_ref_constraint->add_property( iv_principal_property = 'Matnr'   iv_dependent_property = 'Matnr' ). "#EC NOTEXT
lo_assoc_set = model->create_association_set( iv_association_set_name  = 'MatToPlantSet'                         "#EC NOTEXT
                                              iv_left_entity_set_name  = 'MaterialSet'              "#EC NOTEXT
                                              iv_right_entity_set_name = 'PlantSet'             "#EC NOTEXT
                                              iv_association_name      = 'MatToPlant' ).                                 "#EC NOTEXT
...
* Navigation Properties for entity - Material
lo_entity_type = model->get_entity_type( iv_entity_name = 'Material' ). "#EC NOTEXT
lo_nav_property = lo_entity_type->create_navigation_property( iv_property_name  = 'MtoP' "#EC NOTEXT
                                                              iv_abap_fieldname = 'MTOP' "#EC NOTEXT
                                                              iv_association_name = 'MatToPlant' ). "#EC NOTEXT
  endmethod.
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20200522083708'.                  "#EC NOTEXT
