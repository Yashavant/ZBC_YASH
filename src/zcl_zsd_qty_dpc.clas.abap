class ZCL_ZSD_QTY_DPC definition
  public
...
protected section.
  ...
  methods ORDERSET_CREATE_ENTITY
    ...
    exporting
      !ER_ENTITY type ZCL_ZSD_QTY_MPC=>TS_ORDER
    raising
  ...
  methods ORDERSET_GET_ENTITYSET
    ...
    exporting
      !ET_ENTITYSET type ZCL_ZSD_QTY_MPC=>TT_ORDER
...
CLASS ZCL_ZSD_QTY_DPC IMPLEMENTATION.


  method /IWBEP/IF_MGW_APPL_SRV_RUNTIME~CREATE_ENTITY.
*&----------------------------------------------------------------------------------------------*
*&  Include           /IWBEP/DPC_TEMP_CRT_ENTITY_BASE
*&* This class has been generated on 08/09/2020 07:07:58 in client 100
*&*
*&*       WARNING--> NEVER MODIFY THIS CLASS <--WARNING
*&*   If you want to change the DPC implementation, use the
*&*   generated methods inside the DPC provider subclass - ZCL_ZSD_QTY_DPC_EXT
*&-----------------------------------------------------------------------------------------------*

 DATA orderset_create_entity TYPE zcl_zsd_qty_mpc=>ts_order.
...
*&-----------------------------------------------------------------------------------------------*
 ...
 DATA orderset_get_entity TYPE zcl_zsd_qty_mpc=>ts_order.
 DATA lv_entityset_name TYPE string.
...
*&*   generated methods inside the DPC provider subclass - ZCL_ZSD_QTY_DPC_EXT
*&-----------------------------------------------------------------------------------------------*
 DATA orderset_get_entityset TYPE zcl_zsd_qty_mpc=>tt_order.
 DATA lv_entityset_name TYPE string.
...
*&-----------------------------------------------------------------------------------------------*
 ...
 DATA orderset_update_entity TYPE zcl_zsd_qty_mpc=>ts_order.
 DATA lv_entityset_name TYPE string.
 DATA lr_entity TYPE REF TO data. "#EC NEEDED
