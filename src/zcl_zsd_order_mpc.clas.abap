class ZCL_ZSD_ORDER_MPC definition
  public
...
public section.
  ...
  types:
    begin of TS_ORDERFUNCTION,
        WERKS_D type C length 4,
    end of TS_ORDERFUNCTION .
  types:
  ...
  types:
     TS_VBAP type VBAP .
  types:
TT_VBAP type standard table of TS_VBAP .
  types:
  begin of TS_HT001W,
     WERKS type WERKS_D,
     NAME1 type AD_NAME1,
...
TT_HT001W type standard table of TS_HT001W .
  ...
  constants GC_VBAP type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'vbap' ##NO_TEXT.
...
private section.
  ...
  constants GC_INCL_NAME type STRING value 'ZCL_ZSD_ORDER_MPC=============CP' ##NO_TEXT.
...
CLASS ZCL_ZSD_ORDER_MPC IMPLEMENTATION.
...
model->set_schema_namespace( 'ZSD_ORDER_SRV' ).
...
***********************************************************************************************************************************
*   ACTION - OrderFunction
***********************************************************************************************************************************

lo_action = model->create_action( 'OrderFunction' ).  "#EC NOTEXT
...
lo_action->set_return_entity_type( 'vbap' ). "#EC NOTEXT
...
lo_parameter = lo_action->create_input_parameter( iv_parameter_name = 'Werks'    iv_abap_fieldname = 'WERKS_D' ). "#EC NOTEXT
...
lo_action->bind_input_structure( iv_structure_name  = 'ZCL_ZSD_ORDER_MPC=>TS_ORDERFUNCTION' ). "#EC NOTEXT
  endmethod.
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_ZSD_ORDER_MPC=>TS_HT001W' ). "#EC NOTEXT
...
lo_entity_type = model->create_entity_type( iv_entity_type_name = 'vbap' iv_def_entity_set = abap_false ). "#EC NOTEXT
...
*   ENTITY SETS
***********************************************************************************************************************************
lo_entity_set = lo_entity_type->create_entity_set( 'vbapSet' ). "#EC NOTEXT
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20200520074159'.                  "#EC NOTEXT
...
clear ls_text_element.
ls_text_element-artifact_name          = 'OrderFunction'.                                     "#EC NOTEXT
...
ls_text_element-parent_artifact_name   = 'OrderFunction'.                                      "#EC NOTEXT
