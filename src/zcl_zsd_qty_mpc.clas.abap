class ZCL_ZSD_QTY_MPC definition
  public
...
CLASS ZCL_ZSD_QTY_MPC IMPLEMENTATION.
...
model->set_schema_namespace( 'ZSD_QTY_SRV' ).
...
lo_entity_type->bind_structure( iv_structure_name   = 'ZSD_UPD_QTY'
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20200809110756'.                  "#EC NOTEXT
