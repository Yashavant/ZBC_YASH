class ZCL_ZBC_USER_DPC definition
  public
...
protected section.
  ...
  methods USERSET_CREATE_ENTITY
    ...
    exporting
      !ER_ENTITY type ZCL_ZBC_USER_MPC=>TS_USER
    raising
  ...
  methods USERSET_GET_ENTITYSET
    ...
    exporting
      !ET_ENTITYSET type ZCL_ZBC_USER_MPC=>TT_USER
...
CLASS ZCL_ZBC_USER_DPC IMPLEMENTATION.


  method /IWBEP/IF_MGW_APPL_SRV_RUNTIME~CREATE_ENTITY.
*&----------------------------------------------------------------------------------------------*
*&  Include           /IWBEP/DPC_TEMP_CRT_ENTITY_BASE
*&* This class has been generated on 05/22/2020 07:30:54 in client 100
*&*
*&*       WARNING--> NEVER MODIFY THIS CLASS <--WARNING
*&*   If you want to change the DPC implementation, use the
*&*   generated methods inside the DPC provider subclass - ZCL_ZBC_USER_DPC_EXT
*&-----------------------------------------------------------------------------------------------*

 DATA userset_create_entity TYPE zcl_zbc_user_mpc=>ts_user.
...
*&-----------------------------------------------------------------------------------------------*
 ...
 DATA userset_get_entity TYPE zcl_zbc_user_mpc=>ts_user.
 DATA lv_entityset_name TYPE string.
...
*&*   generated methods inside the DPC provider subclass - ZCL_ZBC_USER_DPC_EXT
*&-----------------------------------------------------------------------------------------------*
 DATA userset_get_entityset TYPE zcl_zbc_user_mpc=>tt_user.
 DATA lv_entityset_name TYPE string.
...
*&-----------------------------------------------------------------------------------------------*
 ...
 DATA userset_update_entity TYPE zcl_zbc_user_mpc=>ts_user.
 DATA lv_entityset_name TYPE string.
 DATA lr_entity TYPE REF TO data. "#EC NEEDED
