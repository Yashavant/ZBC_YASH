class ZCL_ZBC_USER_MPC definition
  public
...
private section.
  ...
  constants GC_INCL_NAME type STRING value 'ZCL_ZBC_USER_MPC==============CP' ##NO_TEXT.
...
CLASS ZCL_ZBC_USER_MPC IMPLEMENTATION.
...
model->set_schema_namespace( 'ZBC_USER_SRV' ).
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'Pass' iv_abap_fieldname = 'PASS' ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_ZBC_USER_MPC=>TS_USER' ). "#EC NOTEXT
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20200522073052'.                  "#EC NOTEXT
...
clear ls_text_element.
ls_text_element-artifact_name          = 'Pass'.                 "#EC NOTEXT
ls_text_element-artifact_type          = 'PROP'.                                       "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'user'.                            "#EC NOTEXT
ls_text_element-parent_artifact_type   = 'ETYP'.                                       "#EC NOTEXT
